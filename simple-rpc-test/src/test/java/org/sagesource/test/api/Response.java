...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
   ...
   * @see ResponseStatus
   */
  public ResponseStatus code; // required
   ...
   * @see ResponseStatus
   */
  public Response setCode(ResponseStatus code) {
    this.code = code;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.code = org.sagesource.test.api.ResponseStatus.findByValue(iprot.readI32());
